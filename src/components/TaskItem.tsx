...
export function TaskItem({ task, editTask, removeTask, toggleTaskDone}: TaskItemProps){
    ...
    const [taskNewTitleValue, setTaskNewtTitleValue] = useState(task.title);
    const textInputRef = useRef<TexInput>(null);

    function handleStartEditing() {
        setIsEditing(true);
    }

    function hanldeCancelEditing() {
        setTaskNewtTitleValue(task.title);
        setIsEditing(false);
    }
            ...
            <View style={styles.infoContainer}>
              ...
              >
                ...
                <TextInput
                    ...
                    onChangeText={setTaskNewtTitleValue}
                    editable={isEditing}
